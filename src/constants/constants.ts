...
export namespace Constants {
    ...
    export const markdownFilePath = path.join(workspaceFolder,'.vscode',sepNotesFileName);
    export const markdownFileHead = `<!-- generated by vscode plugin [separable notes](https://github.com/hashhashu/separable-notes)  
-->  \n  \n`;
