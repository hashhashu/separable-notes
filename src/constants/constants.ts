...
export namespace Constants {
    ...
    export const sepNotesMetadataName = 'sepNotes_metadata.json';
    export const sepNotesMetadataPath = path.join(sepNotesRootPath,sepNotesMetadataName);
    export const sepnotesKeyNotesPath = path.join(sepNotesRootPath,'sepNotes_notesKey.json');
    export const sepnotesLineInfoPath = path.join(sepNotesRootPath,'sepNotes_lineInfo.json');
    export const sepnotesLineAccessHistroyPath = path.join(sepNotesRootPath,'sepNotes_lineAccessHistroy.json');
...
export namespace Commands {
    ...
    export const fillLostId = 'separableNotes.fillLostId';
}
